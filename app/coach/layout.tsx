        ...
        <div className="min-h-screen bg-zinc-950 text-white flex">
            ...
            <aside className="w-64 border-r border-zinc-900 bg-zinc-950 p-6 hidden md:flex flex-col">
                <div className="mb-10 flex items-center gap-2">
                    <div className="h-8 w-8 bg-blue-600 rounded-lg flex items-center justify-center font-bold">CT</div>
            ...
            {/* Mobile Header (Coach) */}
            <div className="md:hidden fixed top-0 w-full bg-zinc-950 border-b border-zinc-900 p-4 z-50 flex justify-between items-center">
