            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8 lg:p-12 relative overflow-hidden">
                ...
                <div className="w-full max-w-md space-y-8 relative z-10">
                    ...
                    <form onSubmit={handleLogin} className="space-y-6" autoComplete="off">
                        ...
                        <div className="space-y-2">
                            <div className="flex items-center justify-between">
                                ...
                                <Link href="#" className="text-sm font-medium text-emerald-600 dark:text-[#B2FF59] hover:underline">
                                    Forgot password?
                                </Link>
                            </div>
                            <div className="relative">
                    ...
                    <p className="text-center text-sm text-zinc-600 dark:text-zinc-400">
                        ...
                        <Link href="/#apply" className="font-semibold text-emerald-600 dark:text-[#B2FF59] hover:underline">
                            Get Access
                        </Link>
                    </p>
                ...
                <div className="absolute inset-0 bg-zinc-900">
                    ...
                    <div className="absolute bottom-12 left-12 right-12 text-white">
                        <blockquote className="text-2xl font-bold mb-4 leading-tight">
                            "This platform completely transformed how I manage my online clients. Retention is at an all-time high."
                        </blockquote>
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <div className="text-sm text-emerald-400">Head Coach, Iron Fitness</div>
                            </div>
                        </div>
                    </div>
                </div>
